module.exports = {
  ...
  plugins: ["react"],
  extends: ["plugin:prettier/recommended", "plugin:react/recommended"], //eslint-plugin-prettier和eslint-config-prettier解决eslint、prettier部分规则冲突
  settings: {
    react: {
      version: "detect" //自动检测react版本,也可手动指定版本
    }
  },
  rules: {
